{
  ...
  TH2I* histX = (TH2I*) file.Get("Be7/theta3DeltaPhi_7Be_2_el_midAngle");
  ...
  TH2I* sr = (TH2I*) fileS.Get("theta3DeltaPhi_midAngle_R");
  double Nsr = sr->Integral();
  TH2I* sp = (TH2I*) fileS.Get("theta3DeltaPhi_midAngle_P");
  ...
  for (int i=1;i<=50;i++)
	...
	if (yexp == 0 || yr == 0) corr->SetBinContent(i,j,0.);
        else
