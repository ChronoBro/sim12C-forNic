...
canvas.cd(1);
 ...
 frame1.Draw();
  ...
  TH2I* vzvx_He3 = (TH2I*) f.Get("Li6/vxvz_6Li_da_el_H2");
  vzvx_He3->Draw("cont same");
  TH1I* vzvx_T = f.Get("Li6/vxvz_6Li_da_el_T");
  ...
  TH2I *  swap_He3 = new TH2I("swap_He4","",100,-7,7,100,-7,7);
  TH2I* vxvy_He3 = (TH2I*) f.Get("Li6/vxvy_6Li_da_el_H2");
  for (int i=1;i<=100;i++)
    for (int j=1;j<=100;j++)
      {
        double yy = vxvy_He3->GetBinContent(i,j);
        swap_He3->SetBinContent(j,i,yy);
      }
  swap_He3->Draw("col same");
  ...
  canvas.cd(3);
  frame1.Draw();
  TH2I* vzvx_He4 = (TH2I*) f.Get("Li6/vxvz_6Li_da_el_He4");
  ...
  TH2I* vxvy_He4 = (TH2I*) f.Get("Li6/vxvy_6Li_da_el_He4");
