{
  ...
  TCanvas canvas("ComPsiHi","",600,800);
  canvas.Divide(1,2);
  ...
  canvas.cd(1);
  TH2S frame2("frame2","",10,-1,1,10,0,2700);
  ...
  TH1I* histX3 = (TH1I*) file.Get("Be7/theta3_7Be_2_el_hiAngle");
  histX3->SetMarkerStyle(20);
  //histX3->Draw("same P");
  float Nx3 = histX3->Integral();


  TH1I* sr3 = (TH1I*) fileS.Get("theta3_hiAngle_R");
  sr3->SetLineColor(2);
  ...
  TH1I* sp3 = (TH1I*) fileS.Get("theta3_hiAngle_P");
  sp3->SetLineColor(4);
  ...
  TH2S frame3("frame3","",10,-.5,5.5,10,0,1500);
  ...
  TLatex tt;
  tt.DrawLatex(4.,1300,"j = 7/2^{-}, l = 3");
  tt.DrawLatex(.5,1300,"^{7}Be#rightarrow ^{3}He+#alpha,  #theta^{*}>4.5^{#circ}");
