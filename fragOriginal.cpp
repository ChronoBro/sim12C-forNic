...

{
  ...
  Ring = new ring(149.,15.,42.5,32,64); //Russian detector
  RingCsI = new ring(170.,15.,42.5,32,64);// distance from interaction, min active radius, max active radius, number of rings, number of pie sections
  Ring2 = new ring(358.,11.,35.,48,16);
  Ring2->S2=1;
  Ring2CsI = new ring(380,11.,35.,48,16);
  Ring2CsI->S2=1;
