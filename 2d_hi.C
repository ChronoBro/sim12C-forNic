{
  ...
  TH2I* histX = (TH2I*) file.Get("Be7/theta3DeltaPhi_7Be_2_el_hiAngle");
  ...
  TH2I* sr = (TH2I*) fileS.Get("theta3DeltaPhi_hiAngle_R");
  double Nsr = sr->Integral();
  TH2I* sp = (TH2I*) fileS.Get("theta3DeltaPhi_hiAngle_P");
